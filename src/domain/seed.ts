...
export function seedDB(): DryTrackDB {
  return {
    ...
    messung: [
      { id: "me-1", raum_id: "r-1", messpunkt_id: "mp-1", material_id: "mat-schwimm", messverfahren: "widerstand", anzeige_digit: 78, referenz_digit: null, status_checkliste: null, absolute_feuchte_g_kg: 11.9, temperatur_c: 21, rel_luftfeuchte_prozent: 62, stroemung_m_s: null, messgeraet: "Uni 2 · 323", anlass: "eingangsmessung", gemessen_von: "u-monteur", gemessen_am: tage(8) },
      { id: "me-2", raum_id: "r-1", messpunkt_id: "mp-1", material_id: "mat-schwimm", messverfahren: "widerstand", anzeige_digit: 54, referenz_digit: null, status_checkliste: null, absolute_feuchte_g_kg: 8.9, temperatur_c: 22, rel_luftfeuchte_prozent: 51, stroemung_m_s: null, messgeraet: "Uni 2 · 323", anlass: "eingangsmessung", gemessen_von: "u-monteur", gemessen_am: tage(3) },
      { id: "me-3", raum_id: "r-1", messpunkt_id: null, material_id: "mat-kmf", messverfahren: "widerstand", anzeige_digit: null, referenz_digit: null, status_checkliste: { trocken: false, feucht: true, kontaminiert: false, austausch_erforderlich: true }, absolute_feuchte_g_kg: null, temperatur_c: null, rel_luftfeuchte_prozent: null, stroemung_m_s: null, messgeraet: null, anlass: "eingangsmessung", gemessen_von: "u-monteur", gemessen_am: tage(5) },
      { id: "me-4", raum_id: "r-4", messpunkt_id: null, material_id: "mat-zement", messverfahren: "widerstand", anzeige_digit: 44, referenz_digit: null, status_checkliste: null, absolute_feuchte_g_kg: 7.1, temperatur_c: 23, rel_luftfeuchte_prozent: 45, stroemung_m_s: null, messgeraet: "RTU 600 · 118", anlass: "freimessung", gemessen_von: "u-monteur", gemessen_am: tage(24) },
    ],
    grundriss: [
